...
public class QueueChannel extends AbstractPollableChannel {
	...
	/**
	 * Create a channel with "unbounded" queue capacity. The actual capacity
	 * value is {@link Integer#MAX_VALUE}. Note that a bounded queue is
	 * recommended, since an unbounded queue may lead to OutOfMemoryErrors.
	 */
	public QueueChannel() {
	...
	/**
	 * Remove any {@link Message Messages} that are not accepted by the provided
	 * selector.
	 */
