...
/**
 * Interface for any MessageChannel implementation that accepts subscribers. The
 * subscribers must implement the {@link MessageHandler} interface and will be
 * invoked when a Message is available.
 * 
 * @author Mark Fisher
