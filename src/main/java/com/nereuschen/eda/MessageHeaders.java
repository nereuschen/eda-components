 ...
 * IMPORTANT: MessageHeaders are immutable. Any mutating operation (e.g.,
 * put(..), putAll(..) etc.) will result in
 * {@link UnsupportedOperationException} To create MessageHeaders instance use
 * fluent MessageBuilder API
 * 
 * <pre>
 * MessageBuilder.withPayload(&quot;foo&quot;).setHeader(&quot;key1&quot;, &quot;value1&quot;)
 * 		.setHeader(&quot;key2&quot;, &quot;value2&quot;);
 * </pre>
 * 
 * or create an instance of GenericMessage passing payload as {@link Object} and
 * headers as a regular {@link Map}
 * 
 * <pre>
...
public final class MessageHeaders implements Map<String, Object>, Serializable {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(MessageHeaders.class);
