...
import com.nereuschen.eda.exception.AggregateMessageDeliveryException;
...
public class UnicastingDispatcher extends AbstractDispatcher {
	...
	private boolean doDispatch(Message<?> message) {
		...
		Iterator<MessageHandler> handlerIterator = this
				.getHandlerIterator(message);
	...
	private Iterator<MessageHandler> getHandlerIterator(Message<?> message) {
		...
		try {
			if (this.loadBalancingStrategy != null) {
				return this.loadBalancingStrategy.getHandlerIterator(message,
						this.getHandlers());
			}
		} finally {
			lock.unlock();
